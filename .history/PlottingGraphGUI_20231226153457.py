...
class PointCollectorApp:
    def __init__(self, root, image_path):
        ...
        # Calculate the figure size based on the canvas aspect ratio
        canvas_aspect_ratio = self.canvas.winfo_reqwidth() / self.canvas.winfo_reqheight()
        self.fig_width = 30
        self.fig_height = self.fig_width / canvas_aspect_ratio
