...
class TestPoly(unittest.TestCase):
    ...
    def test_add(self):
        ...
        np.testing.assertEqual(result, expected_result)
    def test_call(self):
        res = poly1(1)
    ...
    def test_mul(self):
        ...
        expected_result1 = np.array([2, 4, 6])
        mult_poly = poly1 * poly2
        expected_result2 = Polynomial(1,3,5,6)
        np.testing.assert_array_equal(mult_constant.coeffs, expected_result1)
        np.assertEqual(mult_poly,expected_result2)
